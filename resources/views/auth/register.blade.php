    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header text-center">
                <div class="mb-3">
                    <img src="{{ asset('images/planificacion.png') }}" alt="Task Icon" class="img-fluid" style="max-height: 100px; display: block; margin: 0 auto;">
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-outline-secondary" id="togglePasswordConfirm" aria-label="Toggle password visibility">
